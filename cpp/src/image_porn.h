...
{
public:
  Image_Porn(std::string model_repository,std::string image_dir);
  void test();
private:
...
//   const std::string model_repository = "/home/diaoaijie/workspace/image-service/image-porn-censor/cpp/src/data/models/cls_image_porn_resnext50_v1.0.0";
//   // const std::string image_dir = "/home/guoweiye/workspace/image-porn-censor/cpp/src/images";
//   const std::string image_dir = "/home/diaoaijie/workspace/image-service/image-porn-censor/cpp/src/images";
//   int run_loop = 1;
